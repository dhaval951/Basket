...
public class ScrollableSegmentedControl: UIControl {
    ...
    private var longestTextWidth:CGFloat = 0
    ...
    private class BaseSegmentCollectionViewCell: UICollectionViewCell {
        ...
        static let imageToTextMargin:CGFloat = 12.0
        static let imageSize:CGFloat = 11.0
        static let defaultFont = UIFont(name: "Roboto", size: 14.0)!
        static let defaultTextColor = UIColor.init(white: 1.0, alpha: 0.7)
        ...
        private func configureConstraints() {
            if let underline = underlineView {
                ...
                underline.heightAnchor.constraint(equalToConstant: 5.0).isActive = true
    ...
    private class TextOnlySegmentCollectionViewCell: BaseSegmentCollectionViewCell {
        ...
        override var selectedContentColor:UIColor? {
            didSet {
                titleLabel.highlightedTextColor = (selectedContentColor == nil) ? UIColor.white : selectedContentColor!
            }
        }
            ...
            didSet {
                if isSelected {
                    if let title = super.selectedAttributedTitle {
                        ...
                        titleLabel.textColor = (selectedContentColor == nil) ? UIColor.white : selectedContentColor!
                    }
                } else {
