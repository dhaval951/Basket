...
extension UIViewController: NVActivityIndicatorViewable {
    ...
    func getUserDetail() -> [String: Any] {
        let UserDetail = UserDefaults.standard.object(forKey: "UserDetail")
        return (UserDetail as? [String : Any])!
    }
    ...
    func GetCitylistAPIFor(FloatinftextField:SkyFloatingLabelTextField)
    {
...
//                FloatinftextField.pickerData.append(CityList(fromJson: json["response_obj"]))
                FloatinftextField.pickerData = json.dictionary!["response_obj"]!.array!
                FloatinftextField.isUserInteractionEnabled = true
            }
            else
            {
                            ...
                            */
                            ...
                            if let httpError = result.result.error {
                                ...
                                let response: [String: Any] = [
                                    ...
                                    "response_code": false,
                                    "response_message": ValidationMessage.somthingWrong
                                ]
...
extension UIView {
    ...
    var shadowRadiusView: CGFloat {
        ...
        set {
            layer.shadowColor = #colorLiteral(red: 0.2527462244, green: 0.568539083, blue: 0.310325861, alpha: 1).cgColor
...
extension UITableView
{
    ...
    func setTextForBlankTableview(message : String, color: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)) -> Void {
        ...
        messageLabel.font = UIFont.init(name: "Roboto", size: 15.0)
